...
%
%\begin{lstlisting}[language=clingo,caption=Reasoning for Truthworthiness aspect, label=lst:q_2_most_vulner, mathescape=true,xleftmargin=.01\textwidth, breaklines=true]
%count_relations(P,N) :- N = #count{C : addressedBy(C,P)}, property(P).
%higher_vulner(P1,P2) :- count_relations(P1,N1), count_relations(P2,N2), N1 > N2.
%not_highest_vulner(P) :- property(P), property(P2), higher_vulner(P2,P).
%highest_vulner(P) :- property(P), not not_highest_vulner(P).
%\end{lstlisting}
