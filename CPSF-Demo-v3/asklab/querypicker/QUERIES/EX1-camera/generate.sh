...
FILES="$BASE/step1-BASE.lp $BASE/theory.lp $BASE/theory-maxint.lp output.lp $BASE/step1.lp $BASE/step2.lp $BASE/step3.lp $BASE/step3-ext.lp $BASE/step3-ext-prob.lp"
OUTPUT=FULL-step3-ext-prob.txt
cat $FILES > $OUTPUT
