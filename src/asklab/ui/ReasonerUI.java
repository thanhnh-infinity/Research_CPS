...
class ExecActionListener implements ActionListener
{
	...
	{	@Override
		...
		{	try
			{	String sparqlQ=Utils.readFile(sparqlFile);
				...
				String res=CPSReasoner.query(sparqlQ,aspQ,ontologyDir,solverConst[solverL.getSelectedIndex()]);
				taRes.setText(res);
	...
	public ExecActionListener(String tmpFile,String ontologyDir,String sparqlFile,JTextArea taASP,JTextArea taRes,JProgressBar progr,JComboBox solverL)
...
public class ReasonerUI
{
	...
	public ReasonerUI()
	{
		...
		JComboBox solverL = new JComboBox(ExecActionListener.solverStrings);
		solverL.setSelectedIndex(0);
