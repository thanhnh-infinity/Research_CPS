...
class owlBase:
    ...
    def addOwlNodes(self):
        ...
        all_concerns = np.array(())


        all_concerns = np.append(all_concerns,self.getOWLObject("Trustworthiness")) 
        
        all_concerns = np.append(all_concerns,self.getOWLObject("Privacy"))   
        all_concerns = np.append(all_concerns,self.getOWLObject("Reliability"))   
        all_concerns = np.append(all_concerns,self.getOWLObject("Resilience"))   
        all_concerns = np.append(all_concerns,self.getOWLObject("Safety"))   
        all_concerns = np.append(all_concerns,self.getOWLObject("Security"))   
        all_concerns = np.append(all_concerns,self.getOWLObject("Cybersecurity"))   
        all_concerns = np.append(all_concerns,self.getOWLObject("Confidentiality"))   
        all_concerns = np.append(all_concerns,self.getOWLObject("Integrity"))   
        all_concerns = np.append(all_concerns,self.getOWLObject("PhysicalSecurity"))   
    ...
    def getOWLObject(self,name):
        ...
        obj_list = self.owlReadyOntology.ontology.search(iri = "*" + name)
        obj_names = []
