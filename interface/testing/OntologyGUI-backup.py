...
class OntologyGUI:
    ...
    def addRelation(self):
        ...
        elif(self.relationParent.type == "Concern" and (self.relationChild.type == "Formula" or self.relationChild.type == "DecompositionFunction" )):

            self.addConcernFormulaRelation()
    
        elif((self.relationParent.type == "Formula" or self.relationParent.type == "DecompositionFunction") and (self.relationChild.type == "Formula" or self.relationChild.type == "DecompositionFunction")):

            self.addFormulaFormulaRelations()
        
        elif((self.relationParent.type == "Formula" or self.relationParent.type == "DecompositionFunction") and (self.relationChild.type == "Property")):
    ...
    def handleRelationAfterPolarity(self):
        ...
        if(self.addingRelation == "IRProperty"):
            ...
            self.addConditionProperty()
            
        elif(self.addingRelation == "ConcernIR"):
            
            self.addIRAddressesConcernRelation()  
            
        elif(self.addingRelation  == "PropertyAsChild"):
